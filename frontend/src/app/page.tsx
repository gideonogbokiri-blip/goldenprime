...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950">
      {/* Nav */}
      <nav className="border-b border-zinc-800/50 px-6 py-4 flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto px-6 py-24 text-center relative">
          <FadeInUp>
            <div className="inline-block mb-6 px-4 py-2 bg-gold-500/10 border border-gold-500/30 rounded-full">
              <span className="text-gold-500 text-sm font-semibold">Launching October 1, 2026</span>
            </div>
          </FadeInUp>
          ...
          <FadeInUp delay={0.3}>
            <div className="flex gap-4 justify-center mb-12">
              <Link href="/register" className="bg-gold-500 text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-gold-400 transition-colors">
                Preorder Now
              </Link>
              <a href="#how-it-works" className="border border-zinc-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-zinc-800 transition-colors">
                Learn More
              </a>
            </div>
          </FadeInUp>
          ...
          <FadeInUp delay={0.4}>
            <div className="flex justify-center mb-12">
              <GoldCoin size={192} showGlow={true} floating={true} />
            </div>
          </FadeInUp>
          ...
          <FadeInUp delay={0.5}>
            <div className="mb-8">
              <p className="text-gray-400 mb-4 text-sm uppercase tracking-wider">Time Until Launch</p>
      ...
      <section id="how-it-works" className="max-w-5xl mx-auto px-6 py-20">
        <FadeInUp>
          ...
          <p className="text-gray-400 text-center mb-12">Start investing in GoldenPrime Gold Coin in 3 simple steps</p>
        </FadeInUp>
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8" delay={0.2}>
          {[
            ...
            <StaggerItem key={item.step}>
              ...
              >
                <div className="text-gold-500 text-4xl font-bold mb-4">{item.step}</div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 border-t border-zinc-800/50">
        <FadeInUp>
          <div className="bg-gradient-to-r from-gold-500/10 via-zinc-900 to-gold-500/10 border border-gold-500/20 rounded-2xl p-10 text-center">
            <h2 className="text-3xl font-bold mb-4">Refer & Earn Gold</h2>
            ...
            <StaggerContainer className="flex items-center justify-center gap-8 mb-8" stagger={0.15}>
              {[
                ...
                <StaggerItem key={stat.label}>
                  ...
                  {i < 2 && <div className="w-px h-12 bg-zinc-700 hidden md:block" />}
                </StaggerItem>
              ))}
            </StaggerContainer>
            <Link href="/register" className="bg-gold-500 text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-gold-400 transition-colors inline-block">
              Start Earning
            </Link>
          </div>
        </FadeInUp>
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-800/50 px-6 py-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-2xl font-bold"><span className="text-gold-500">Golden</span>Prime</div>
          <div className="flex gap-6 items-center">
            <Link href="/whitepaper" className="text-gray-400 hover:text-gold-500 text-sm transition-colors">Whitepaper</Link>
            <Link href="/register" className="text-gray-400 hover:text-white text-sm transition-colors">Get Started</Link>
            <Link href="/login" className="text-gray-400 hover:text-white text-sm transition-colors">Sign In</Link>
          </div>
          <p className="text-gray-500 text-sm">&copy; 2026 GoldenPrime Investments Ltd. All rights reserved.</p>
        </div>
      </footer>
    </main>
  );
