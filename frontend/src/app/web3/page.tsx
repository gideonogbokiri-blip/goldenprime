  ...
  return (
    <main className="min-h-screen bg-zinc-950">
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        <motion.h2 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-3xl font-semibold mb-2">
          Web3 Wallet
        </motion.h2>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
          ...
          <h3 className="text-lg font-semibold mb-4">Why Connect a Wallet?</h3>
