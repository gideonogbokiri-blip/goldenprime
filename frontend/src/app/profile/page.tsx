  ...
  return (
    <main className="min-h-screen bg-zinc-950">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-6 md:py-10">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6 md:mb-8">My Profile</h2>

        {/* Account Info */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
          <h3 className="text-base md:text-xl font-semibold mb-4">Account Information</h3>
        ...
        {/* Bank Details */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
          <h3 className="text-base md:text-xl font-semibold mb-4">Saved Bank Details</h3>
          {bankDetails ? (
            <div className="grid grid-cols-2 gap-4">
              <div>
        ...
        {/* Card Details */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
          <h3 className="text-base md:text-xl font-semibold mb-4">Saved Card Details</h3>
          {cardDetails ? (
            <div className="grid grid-cols-2 gap-4">
              <div>
        ...
        {/* KYC Status */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
          <h3 className="text-base md:text-xl font-semibold mb-4">Identity Verification (KYC)</h3>
          {kyc ? (
